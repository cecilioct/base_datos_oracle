...
CREATE TABLE calendario (
  calendario_id NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
CREATE TABLE catalogo_actividades (
  catalogo_act_id NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
CREATE TABLE encabezado_reporte (
  encabezado_id NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
CREATE TABLE estado_revision (
  estado_rev_id NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
CREATE TABLE lineas_reporte (
  lineas_id NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
CREATE TABLE revisiones_actividad (
  rev_act_id NUMBER GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
ALTER TABLE encabezado_reporte
   ADD CONSTRAINT encabezado_anio_fk FOREIGN KEY (anio) REFERENCES calendario (calendario_id) ON DELETE CASCADE
   ADD CONSTRAINT encabezado_aproba_cliente_fk FOREIGN KEY (aprobador_cliente) REFERENCES contacto (contacto_id) ON DELETE CASCADE
   ADD CONSTRAINT encabezado_aproba_interno FOREIGN KEY (aprobador_interno) REFERENCES contacto (contacto_id) ON DELETE CASCADE
   ADD CONSTRAINT encabezado_cliente_fk FOREIGN KEY (cliente_id) REFERENCES empresa (empresa_id) ON DELETE CASCADE
   ADD CONSTRAINT encabezado_consultor_fk FOREIGN KEY (consultor_id) REFERENCES contacto (contacto_id) ON DELETE CASCADE
   ADD CONSTRAINT encabezado_proyecto_fk FOREIGN KEY (proyecto_id) REFERENCES proyecto (id_proyecto) ON DELETE CASCADE

-- CONSTRAINTs for table lineas_reporte
--
ALTER TABLE lineas_reporte
   ADD CONSTRAINT lineas_actividad_fk FOREIGN KEY (actividad_id) REFERENCES catalogo_actividades (catalogo_act_id) ON DELETE CASCADE
   ADD CONSTRAINT lineas_encabezado_fk FOREIGN KEY (encabezado_reporte_id) REFERENCES encabezado_reporte (encabezado_id) ON DELETE CASCADE
   ADD CONSTRAINT lineas_fecha_fk FOREIGN KEY (fecha_actividad) REFERENCES calendario (calendario_id) ON DELETE CASCADE

-- CONSTRAINTs for table revisiones_actividad
--
ALTER TABLE revisiones_actividad
   ADD CONSTRAINT revisiones_contacto_fk FOREIGN KEY (reviso_cliente) REFERENCES contacto (contacto_id) ON DELETE CASCADE
   ADD CONSTRAINT revisiones_contactosup_fk FOREIGN KEY (reviso_supervisor) REFERENCES contacto (contacto_id) ON DELETE CASCADE
